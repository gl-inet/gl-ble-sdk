...
sl_status_t sl_bt_dfu_flash_set_address(uint32_t address) {
    ...
    if (ENDIAN)
    {
        reverse_endian((uint8_t *)&address, 4);
    }
...
sl_status_t sl_bt_system_set_tx_power(int16_t min_power,
    ...
    if (ENDIAN)
    {
        reverse_endian((uint8_t *)&min_power, 2);
        reverse_endian((uint8_t *)&max_power, 2);
    }
    ...
    if(ENDIAN)
    {
        reverse_endian((uint8_t *)&rsp->data.rsp_system_set_tx_power.set_min, 2);
        reverse_endian((uint8_t *)&rsp->data.rsp_system_set_tx_power.set_max, 2);
    }
...
sl_status_t sl_bt_scanner_set_parameters(uint8_t mode,
    ...
    if (ENDIAN)
    {
        ...
        reverse_endian((uint8_t *)&window, 2);
    }
...
sl_status_t sl_bt_gattdb_add_uuid16_characteristic(uint16_t session,
    ...
    uint16_t reverse_len = value_len;
    if (ENDIAN)
    {
        reverse_endian((uint8_t *)&session, 2);
        reverse_endian((uint8_t *)&service, 2);
        reverse_endian((uint8_t *)&property, 2);
        reverse_endian((uint8_t *)&security, 2);
        reverse_endian((uint8_t *)&maxlen, 2);
        reverse_endian((uint8_t *)&reverse_len, 2);
    }
    ...
    cmd->data.cmd_gattdb_add_uuid16_characteristic.value.len=reverse_len;
...
sl_status_t sl_bt_gattdb_add_uuid128_characteristic(uint16_t session,
    ...
    cmd->data.cmd_gattdb_add_uuid128_characteristic.value.len=reverse_len;
...
sl_status_t sl_bt_gattdb_add_uuid16_descriptor(uint16_t session,
    ...
    cmd->data.cmd_gattdb_add_uuid16_descriptor.value.len=reverse_len;
...
sl_status_t sl_bt_gattdb_add_uuid128_descriptor(uint16_t session,
    ...
    cmd->data.cmd_gattdb_add_uuid128_descriptor.value.len=reverse_len;
...
sl_status_t sl_bt_gatt_server_find_attribute(uint16_t start,
    ...
    if(ENDIAN)
    {
        reverse_endian((uint8_t *)&start, 2);
    }
